...
public sealed class RabbitMqPaymentSucceededConsumer
    : RabbitMqConsumerBase<PaymentSucceededIntegrationEvent>
{
    ...
    protected override string QueueName => _options.PaymentSucceededQueueName;

    protected override string RoutingKey => _options.PaymentSucceededRoutingKey;
