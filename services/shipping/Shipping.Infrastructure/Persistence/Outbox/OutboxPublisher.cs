...
namespace Shipping.Infrastructure.Persistence.Outbox;
...
public sealed class OutboxPublisher
{
    ...
    public OutboxPublisher(ShippingDbContext context, IRawMessagePublisher publisher, ILogger<OutboxPublisher> logger)
    {
        _context = context;
